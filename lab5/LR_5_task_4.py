...
# Завантаження оригінального набору даних Boston Housing
...
# Створення регресора на основі AdaBoost
...
# Назви ознак (для Boston Housing використовуються стандартні 13 ознак)
